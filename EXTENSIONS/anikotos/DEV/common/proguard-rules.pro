# ════════════════════════════════════════════════════════════════════
# AniKoto S 180 — ProGuard / R8 rules
# ════════════════════════════════════════════════════════════════════
...
# server lists, video sources). Keeping everything in the anikotos package
# (including nested classes + subpackages like .video) is the safest
# approach — prevents R8 from stripping or renaming serializers, companion
# objects, or @SerialName fields.
-keep class eu.kanade.tachiyomi.animeextension.en.anikotos.** { *; }
