...
# search results, etc.). Keeping everything in the animepahe package
# (including nested classes + subpackages like .dto) is the safest
# approach — prevents R8 from stripping or renaming serializers,
# companion objects, or @SerialName fields.
-keep class eu.kanade.tachiyomi.animeextension.en.animepahe.** { *; }
-keep class eu.kanade.tachiyomi.animeextension.en.animepahe.extractor.jsunpacker.** { *; }
