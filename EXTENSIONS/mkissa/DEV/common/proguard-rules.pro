...
# search results, etc.). Keeping everything in the mkissa package
...
-keep class eu.kanade.tachiyomi.animeextension.en.mkissa.** { *; }
-keep class eu.kanade.tachiyomi.animeextension.en.mkissa.extractor.jsunpacker.** { *; }
