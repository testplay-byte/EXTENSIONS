...
|---|---|---|---|---|---|---|
| **AniKoto 180** | [`EXTENSIONS/anikoto/`](../EXTENSIONS/anikoto/) | `en` | ✅ All features working | v16.10 (Build 10, versionCode 10, versionId 11) | anikototv.to (+ 5 mirrors selectable in settings) | `...en.anikoto.Anikoto` |
